...
@section('titleHeader', 'Étudiant')
@section('content')
        <div class="row mt-5">
            <div class="col-12">
                <a href="{{route('college.index')}}" class="btn btn-outline-primary btn-sm">Retourner</a>
                <hr>
        ...
        <div class="row">
            <div class="col-6">
                <a href="{{ route('college.edit', $etudiant->id)}}" class="btn btn-success">Modifier</a>
            </div>
            <div class="col-6">
