  ...
  <header class="header">
    ...
    <nav class="container">
      <ul class="header-menu-container header-container">
        <li class="menu-item">
          <a href="." class="">
            <h2 class="title--logo-primary">Spiro</h2>
          </a>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-item"><a href="catalogue">Catalogue</a></li>
        <li class="menu-item"><a href="about">À propos</a></li>
        <li class="menu-item"><a href="inscription">Créer un compte</a></li>
      </ul>
    </nav>
    <nav class="container">
    ...
    <nav class="container">
      <div class="menu-container py-xlarge">
        ...
        <div class="footer-column">
          <div class="footer-column-group">
            ...
            <div class="footer-column-heading">
              <h2 class="title--logo-secondary">Aspirateurs international</h2>
            </div>

            <div class="footer-column-heading">
              <p>1010 St-Laurent</p>
              <p>Montréal (Qc) H3M 1A3</p>
            </div>
          </div>
        ...
        <div class="footer-column">
          ...
          <div class="footer-column-group">
            ...
            <ul class="footer-menu">
              ...
              <li class="menu-item"><a href="timbre.html">Trouver le bon modèle</a></li>
        ...
        <div class="footer-column">
          <div class="footer-column-group">
            <div class="footer-column-heading">
              <h3 class="">À propos de Monsieur Spiro</h3>
            </div>
            <ul class="footer-menu">
              <li class="menu-item"><a href="timbre.html">Les aspirateurs, c’est la vie</a></li>
              <li class="menu-item"><a href="timbre.html">Biographie</a></li>
